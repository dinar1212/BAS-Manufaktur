<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
            ...
            <span class="brand-text font-weight-light">BAS Dashboard</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/benang" class="menu-link">
                    <div data-i18n="Account">Benang</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/supplier" class="menu-link">
                    <div data-i18n="Notifications">Supplier</div>
                  </a>
                </li>
                <li class="menu-item">
